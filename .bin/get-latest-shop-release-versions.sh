...
if [[ $(git diff HEAD "${COMPATIBILITY_FILE}") != '' ]]; then
    ...
    cd /home/travis/build/wirecard/prestashop-ee/shop-extension-versions && git push https://"${GITHUB_TOKEN}"@github.com/brkicadis/shop-extension-versions.git HEAD:master
fi
